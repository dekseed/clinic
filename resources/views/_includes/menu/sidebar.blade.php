        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a href="{{ route('manage.dashboard') }}" class="ai-icon" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">ข้อมูลผู้ใช้</span>
						</a>
                        <ul aria-expanded="false">
							<li><a href="{{ route('user.index') }}">รายการ</a></li>
							<li><a href="{{ route('permission.index') }}">สิทธิการใช้งาน</a></li>
                            <li><a href="{{ route('role.index') }}">บทบาทหน้าที่</a></li>
						</ul>
                    </li>
                    {{-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
